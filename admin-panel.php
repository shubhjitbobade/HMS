...
//featch the records in the patient registraction form ans store in varivables
$pid = $_SESSION['pid'];
...
//featch the records form patenreg and doctreg table and stored in variable
if (isset($_POST['app-submit'])) {
  ...
  if (date("Y-m-d", $appdate1) >= $cur_date) {
    if ((date("Y-m-d", $appdate1) == $cur_date and date("H:i:s", $apptime1) > $cur_time) or date("Y-m-d", $appdate1) > $cur_date) {
      ...
      //********************insert values in apptable( for patient and doctor details are stored here*****************
...
//when user cancled appon then apponment status shuld be change
...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <a class="navbar-brand" href="#">X Hospital </a>
